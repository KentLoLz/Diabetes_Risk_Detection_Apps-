...
// set up the AlertDialog
  AlertDialog alert = const AlertDialog(
    ...
    content: Text(
        "Polydipsia is the term given to excessive thirst and is one of the initial symptoms of diabetes. It is also usually accompanied by temporary or prolonged dryness of the mouth and feeling thirsty all the time  "),
  );
...
class RiskQues2 extends StatefulWidget {
  @override
  State<RiskQues2> createState() => _RiskQues2State();
}

class _RiskQues2State extends State<RiskQues2> {
  int finalvar = 0;
  // List<Response> data = <Response>[];
  // Response lol = Response(predictData: 0);
  // List<Response> getAnswer() {
